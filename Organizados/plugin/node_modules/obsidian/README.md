...
```yaml
---
tags: #api, #obsidian, #plugin-development
title: Obsidian API
description: Documentation and examples for the latest Obsidian API.
---
```
...
- **PD
[[sample_banca_reporte.pdf]]: We started by writing down the essential details, like the paper ’s title, publishing year, author 
list, and publisher.  
We then included other details to carry out the systematic review, like the t
